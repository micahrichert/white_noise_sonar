...
constexpr unsigned int SAMPLE_RATE = 100000; // in Hz
...
constexpr double XCOR_DISPLAY_TIME = 1;  // s
constexpr double SPEED_OF_SOUND = 340.3/2.0;  // m/s, divide by 2 because sound travels out and back

constexpr bool USE_AVE_OUTPUT = false;  // minimizes DC of the output but causes higher correlations in time
